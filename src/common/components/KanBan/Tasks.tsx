...
export default function Tasks({
  ...
  tasks?: ReportListItemEntity[];
  columns: any;
  onMove: (id: string, status: string) => Promise<void>;
}) {
  const [data, setData] = useState<ReportListItemEntity[] | undefined>(
    undefined
  );
            ...
            {containers.map((containerId) => {
              return (
                <SectionItem
                  ...
                  name={
                    columns.filter((c: any) => "column-" + c.id === containerId)[0].name
                  }
                  data={data}
            ...
            {activeId ? (
              containers.includes(activeId) ? (
                <SectionItem
                  ...
                  name={
                    columns.filter((c: any) => "column-" + c.id === activeId)[0].name
                  }
                  data={data}
                  dragOverlay
                />
